    ...
    return (
        <div className={'flex text-black relative'}>
            ...
            <input
                ...
                type={type?type:"text"}
                step={"0.01"}
                className={` px-3 block w-full border-0 p-0 text-black placeholder:text-gray-400 focus-visible:outline-none sm:text-sm sm:leading-6 hover:bg-emerald-50 ${className || ''} ${headerDisplay?'pl-4':''}`}
                value={inputText}
